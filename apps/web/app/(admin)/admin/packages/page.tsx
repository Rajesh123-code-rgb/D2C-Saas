        ...
        <div className="space-y-8 pb-10">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-400 mt-2 text-lg">Manage credit top-up packages for tenants</p>
                </div>
                ...
                {packages.map((pkg) => (
                    <GlassCard
                        ...
                        className={cn(
                            ...
                            pkg.isPopular ? "border-indigo-500/50 shadow-lg shadow-indigo-500/10" : "hover:border-white/20"
                        )}
                    >
                        {pkg.isPopular && (
                        ...
                        <CardHeader className="pt-6 relative z-0">
                            <div className="flex items-center justify-between mb-4">
                                <div className={cn(
                                    ...
                                    pkg.isPopular ? "bg-indigo-500/20 text-indigo-400" : "bg-white/5 text-slate-400"
                                )}>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="pt-4 border-t border-white/5 space-y-4">
                                <div className="flex justify-between text-sm">
                                    <span className="text-slate-500">Rate per 100 credits</span>
                                    <span className="text-slate-300">{formatCurrency(pkg.price / pkg.credits * 100)}</span>
                                </div>
                ...
                <DialogContent className="bg-[#0B0C15] border-white/10 text-white sm:max-w-[425px]">
                    ...
                    {editingPackage && (
                        <div className="space-y-4 py-4">
                            ...
                            <div className="space-y-2">
                                <Label className="text-slate-300">Bonus Credits</Label>
                                <Input
                                    type="number"
                            ...
                            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
                                <Label className="text-slate-300">Package Active</Label>
                                <Switch
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleSavePackage} className="bg-indigo-600 hover:bg-indigo-500 text-white">

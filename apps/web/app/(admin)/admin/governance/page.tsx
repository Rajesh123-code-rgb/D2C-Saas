        ...
        <div className="flex-1 space-y-8 pb-10">
            ...
            <Tabs defaultValue="automation" className="space-y-8">
                <TabsList className="bg-white/5 border border-white/10 w-full justify-start p-1 h-auto grid grid-cols-3 max-w-2xl">
                    <TabsTrigger value="automation" className="flex items-center gap-2 py-3 data-[state=active]:bg-neutral-700 data-[state=active]:text-white text-neutral-400">
                        <Cpu className="h-4 w-4" />
                        Automation
                    </TabsTrigger>
                    <TabsTrigger value="whatsapp" className="flex items-center gap-2 py-3 data-[state=active]:bg-neutral-700 data-[state=active]:text-white text-neutral-400">
                        <MessageSquare className="h-4 w-4" />
                        WhatsApp
                    </TabsTrigger>
                    <TabsTrigger value="email" className="flex items-center gap-2 py-3 data-[state=active]:bg-neutral-700 data-[state=active]:text-white text-neutral-400">
